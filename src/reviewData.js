...
export function displayReview(reviewData, messagesDiv, welcomeMessage, currentChatId, db) {
    ...
    editBtn.addEventListener('click', () => toggleEditMode(reviewCard, reviewData, messagesDiv, welcomeMessage, currentChatHistory));
    ...
    confirmBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            displayMessage('আপনার তথ্য সফলভাবে ফায়ারবেজে পাঠানো হয়েছে!', 'bot', messagesDiv, welcomeMessage, saveChatHistory, currentChatId);
            ...
            downloadBtn.addEventListener('click', () => {
                ...
                if (pdfUrl) {
                    ...
                    displayMessage('পিডিএফ ডাউনলোডের জন্য URL পাওয়া যায়নি।', 'bot', messagesDiv, welcomeMessage, saveChatHistory, currentChatId);
                }
            });
            ...
            displayMessage(errorMessage, 'bot', messagesDiv, welcomeMessage, saveChatHistory, currentChatId);
...
export function toggleEditMode(card, reviewData, messagesDiv, welcomeMessage, currentChatId) {
    if (card.getAttribute('data-confirmed') === 'true') {
        displayMessage('ডেটা কনফার্ম হয়ে গেছে। এডিট করা যাবে না।', 'bot', messagesDiv, welcomeMessage, saveChatHistory, currentChatId);
        return;
    }
            ...
            if (typeof value === 'string' && (value.startsWith('http') || value.startsWith('data:image'))) {
                ...
                replaceInput.addEventListener('change', () => {
                    ...
                    if (file) {
                        ...
                        displayMessage('কোনো ইমেজ সিলেক্ট করা হয়নি।', 'bot', messagesDiv, welcomeMessage, saveChatHistory, currentChatId);
                    }
                });
            } else {
